# Microbots C6 Public App

Public update repository for the Microbots Android controller app.
...
Current release version: `v0.1.32`

Firmware OTA assets in each release:

- `firmware-manifest.json`
- `microbots_codecell_c6_drive.bin`
